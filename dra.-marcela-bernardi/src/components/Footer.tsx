        ...
        >
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="text-white flex flex-col justify-center">
              <h2 className="text-2xl md:text-3xl tracking-[0.15em] font-light leading-none mb-2">MARCELA BERNARDI</h2>
          ...
          <div className="text-white text-sm md:text-base font-light leading-relaxed text-center md:text-left">
            <p>Av. Angélica, 2.466, Conj. 252 -</p>
      ...
      <div className="bg-[#CBE4D4] py-5 relative">
        <div className="max-w-7xl mx-auto px-4 md:px-12 text-center">
          <p className="text-[#5a8a6a] text-xs font-light">
            Copyright © 2026 <a href="#" className="underline hover:text-[#2C3E35] transition-colors">marcelabernardi.com.br</a> - Desenvolvido por <a href="#" className="underline hover:text-[#2C3E35] transition-colors">Hi! Creative Lab</a>
          </p>
        </div>
